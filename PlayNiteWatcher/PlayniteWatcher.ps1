...
. (Join-Path $path "Playnite-Common.ps1")

$playNitePath = Get-PlayniteDesktopExeFromConfig -RepoRoot $path
$sunshineConfigPath = "C:\\Program Files\\Sunshine\\config"
$fullScreenPath = Join-Path (Split-Path -Path $playNitePath -Parent) "Playnite.FullscreenApp.exe"
