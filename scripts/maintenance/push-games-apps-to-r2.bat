...
echo Upload local .zip / .7z to Cloudflare R2 origin...
echo.
powershell -NoLogo -NoProfile -ExecutionPolicy Bypass -File "%PS_SCRIPT%" -Push %*
set "ERR=!errorlevel!"
echo.
if !ERR! neq 0 (
    echo [!] Upload exited with code !ERR!
) else (
